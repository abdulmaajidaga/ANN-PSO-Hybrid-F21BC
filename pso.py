...
class ParticleSwarm(object):
    def  __init__(self, num_particles, num_informants, objective_function, particle_length_continuous, num_discrete_variables = None, num_discrete_options = None, alpha = 0.9, beta = 0.6, gamma = 1.0, delta = 0.8, epsilon = 0.15, particles = None ):
        ...
        self.particle_informant_indices, self.particle_informant_best = self.create_particle_informant_best_nearest(num_informants) # Stores informants best positions at each particles index
    ...
    def _update(self):
        ...
        # Generated by ChatGPT 
        # Normalize discrete variables in each particle within the particle array
        # To maintain probability distributionsfor each discrete variable
