...
def initialize_particles(ann):
    ...
    print(f"Particle Length: {continuous_variables_length + discrete_variables_length} (Continuous: {continuous_variables_length}, Discrete: {discrete_variables_length})")
